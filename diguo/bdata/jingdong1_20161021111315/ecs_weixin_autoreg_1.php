...
E_C("CREATE TABLE `ecs_weixin_autoreg` (
  ...
  `autoreg_rand` tinyint(20) unsigned NOT NULL,
  `autoreg_name` varchar(200) NOT NULL,
  `userpwd` varchar(20) NOT NULL,
  `open_email` tinyint(1) NOT NULL DEFAULT '0',
  `email` varchar(200) NOT NULL,
  PRIMARY KEY (`autoreg_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8");
E_D("replace into `ecs_weixin_autoreg` values('1','6','clg_','today_','1','@chaligou.com');");
