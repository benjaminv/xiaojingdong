...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','怕冷哥哥网络商城','0');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','怕冷哥哥网络商城购','1');");
...
E_D("replace into `ecs_shop_config` values('106','1','shop_province','manual','','','7','1');");
E_D("replace into `ecs_shop_config` values('107','1','shop_city','manual','','','97','1');");
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','江南区沙井大道华南城','1');");
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','497401495','1');");
E_D("replace into `ecs_shop_config` values('110','1','ww','text','','','diaoerlangdang1','1');");
...
E_D("replace into `ecs_shop_config` values('114','1','service_email','text','','','497401495@qq.com','1');");
E_D("replace into `ecs_shop_config` values('115','1','service_phone','text','','','18530181714','1');");
...
E_D("replace into `ecs_shop_config` values('202','2','icp_number','text','','','桂ICP备20154200号','1');");
...
E_D("replace into `ecs_shop_config` values('503','5','smtp_user','text','','','liaoshengfei@163.com','1');");
E_D("replace into `ecs_shop_config` values('504','5','smtp_pass','password','','','lsf850817','1');");
E_D("replace into `ecs_shop_config` values('505','5','smtp_mail','text','','','liaoshengfei@163.com','1');");
...
E_D("replace into `ecs_shop_config` values('616','6','affiliate','hidden','','','a:3:{s:6:\"config\";a:7:{s:6:\"expire\";d:24;s:11:\"expire_unit\";s:4:\"hour\";s:11:\"separate_by\";i:0;s:15:\"level_point_all\";s:3:\"10%\";s:15:\"level_money_all\";s:4:\"100%\";s:18:\"level_register_all\";i:2;s:17:\"level_register_up\";i:60;}s:4:\"item\";a:5:{i:0;a:2:{s:11:\"level_point\";s:3:\"60%\";s:11:\"level_money\";s:3:\"60%\";}i:1;a:2:{s:11:\"level_point\";s:3:\"30%\";s:11:\"level_money\";s:3:\"30%\";}i:2;a:2:{s:11:\"level_point\";s:2:\"7%\";s:11:\"level_money\";s:2:\"7%\";}i:3;a:2:{s:11:\"level_point\";s:2:\"3%\";s:11:\"level_money\";s:2:\"3%\";}i:4;a:2:{s:11:\"level_point\";d:0;s:11:\"level_money\";i:0;}}s:2:\"on\";i:1;}','1');");
...
E_D("replace into `ecs_shop_config` values('998','10','supplier_notice','textarea','','','尊敬的供货商您好，欢迎您使用今天优品多商户系统！','245');");
E_D("replace into `ecs_shop_config` values('999','10','supplier_rebate_paytype','textarea','','','支付宝转账\r\n银行转账\r\n微信支付\r\n财付通转账','250');");
E_D("replace into `ecs_shop_config` values('150','1','erweima_wapurl','text','','','http://palenggege.com/mobile/goods.php?id={id}','1');");
...
E_D("replace into `ecs_shop_config` values('1003','3','email_domain','textarea','','','163.com,demo.coolhong.com','1');");
...
E_D("replace into `ecs_shop_config` values('100','1','shop_url','text','','','http://www.chaligou.com/','1');");
E_D("replace into `ecs_shop_config` values('20000','11','chat_server_ip','text','','','120.24.7.99','1');");
...
E_D("replace into `ecs_shop_config` values('20004','11','chat_server_admin_password','password','','','jtypof!@#','1');");
E_D("replace into `ecs_shop_config` values('2000','19','appkey','text','','','','1');");
E_D("replace into `ecs_shop_config` values('2001','19','secretKey','password','','','','1');");
E_D("replace into `ecs_shop_config` values('2002','19','dayu_shop_mobile','text','','','','1');");
E_D("replace into `ecs_shop_config` values('2003','19','dayu_order_placed','select','1,0','','1','5');");
E_D("replace into `ecs_shop_config` values('2004','19','dayu_order_payed','select','1,0','','1','7');");
E_D("replace into `ecs_shop_config` values('2005','19','dayu_order_shipped','select','1,0','','1','9');");
E_D("replace into `ecs_shop_config` values('2006','19','dayu_order_placed_tpl','text','','','SMS_4535139','6');");
E_D("replace into `ecs_shop_config` values('2007','19','dayu_order_payed_tpl','text','','','SMS_4535140','8');");
E_D("replace into `ecs_shop_config` values('2008','19','dayu_order_pay','select','1,0','','1','11');");
E_D("replace into `ecs_shop_config` values('2009','19','dayu_order_pay_tpl','text','','','SMS_4535144','12');");
E_D("replace into `ecs_shop_config` values('2011','19','dayu_sign','text','','','','1');");
E_D("replace into `ecs_shop_config` values('2012','19','dayu_zhuce','select','1,0','','1','1');");
E_D("replace into `ecs_shop_config` values('2013','19','dayu_zhuce_tpl','text','','','','2');");
E_D("replace into `ecs_shop_config` values('2010','19','dayu_order_shipped_tpl','text','','','SMS_4535141','10');");
E_D("replace into `ecs_shop_config` values('2014','19','dayu_xiugai','select','1,0','','1','13');");
E_D("replace into `ecs_shop_config` values('2015','19','dayu_xiugai_tpl','text','','','','14');");
E_D("replace into `ecs_shop_config` values('2016','19','dayu_bangding','select','1,0','','1','15');");
E_D("replace into `ecs_shop_config` values('2017','19','dayu_bangding_tpl','text','','','','16');");
