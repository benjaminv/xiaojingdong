...
E_D("replace into `ecs_nav` values('15','','0','关于我们','1','1','1','http://www.chaligou.com/','bottom');");
E_D("replace into `ecs_nav` values('16','','0','联系我们','1','2','1','http://www.chaligou.com/','bottom');");
