...
E_D("replace into `ecs_ecsmart_shop_config` values('101','1','shop_name','text','','','怕冷哥哥网络商城','1');");
E_D("replace into `ecs_ecsmart_shop_config` values('102','1','shop_title','text','','','怕冷哥哥网络商城','1');");
E_D("replace into `ecs_ecsmart_shop_config` values('103','1','shop_desc','text','','','怕冷哥哥网络商城','1');");
E_D("replace into `ecs_ecsmart_shop_config` values('104','1','shop_keywords','text','','','ecshop','1');");
E_D("replace into `ecs_ecsmart_shop_config` values('115','1','service_phone','text','','','15077171666','1');");
...
E_D("replace into `ecs_ecsmart_shop_config` values('501','5','smtp_host','text','','','smtp.163.com','1');");
E_D("replace into `ecs_ecsmart_shop_config` values('502','5','smtp_port','text','','','25','1');");
E_D("replace into `ecs_ecsmart_shop_config` values('503','5','smtp_user','text','','','liaoshengfei@163.com','1');");
E_D("replace into `ecs_ecsmart_shop_config` values('504','5','smtp_pass','password','','','lsf850817','1');");
E_D("replace into `ecs_ecsmart_shop_config` values('505','5','smtp_mail','text','','','liaoshengfei@163.com','1');");
...
E_D("replace into `ecs_ecsmart_shop_config` values('616','6','affiliate','hidden','','','a:3:{s:6:\"config\";a:13:{s:6:\"expire\";d:0;s:11:\"expire_unit\";N;s:11:\"separate_by\";i:0;s:15:\"level_point_all\";d:0;s:15:\"level_money_all\";d:0;s:18:\"level_register_all\";i:0;s:17:\"level_register_up\";i:0;s:9:\"parent_id\";N;s:15:\"ex_fenxiao_flag\";N;s:19:\"ex_fenxiao_personal\";s:1:\"1\";s:20:\"level_money_personal\";d:5;s:20:\"level_point_personal\";d:5;s:20:\"personal_lever_money\";s:2:\"30\";}s:4:\"item\";a:2:{i:0;a:2:{s:11:\"level_point\";s:3:\"80%\";s:11:\"level_money\";s:3:\"10%\";}i:1;a:2:{s:11:\"level_point\";s:3:\"15%\";s:11:\"level_money\";s:3:\"35%\";}}s:2:\"on\";i:1;}','1');");
