...
E_D("replace into `ecs_weixin_act` values('1','砸金蛋','砸金蛋了哦亲！本功能正在测试中，亲们请谅解。','1','1','10','1','2016-08-15');");
E_D("replace into `ecs_weixin_act` values('2','刮刮卡','刮刮卡！','1','2','100','2','2017-12-08');");
