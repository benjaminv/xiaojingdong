...
<head>
<base href="http://localhost/jingdong1/" />
...
<?php $this->assign('cat_goods',$this->_var['cat_goods_25']); ?><?php $this->assign('goods_cat',$this->_var['goods_cat_25']); ?><?php $this->assign('sort_order',$this->_var['goods_cat_25_sort_order']); ?><?php $this->assign('ext_info',$this->_var['goods_cat_25_ext_info']); ?><?php echo $this->fetch('library/cat_goods.lbi'); ?>
