	...
	<ul>
        ...
        <li class="tag">
        	<dl>
            	<dt>买家印象：</dt>
                <dd>
                	<?php $_from = $this->_var['comment_tags']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('tag_key', 'value_0_57890400_1476967725');if (count($_from)):
    foreach ($_from AS $this->_var['tag_key'] => $this->_var['value_0_57890400_1476967725']):
?>
                	<span onClick="ShowMyComments(<?php echo $this->_var['goods']['goods_id']; ?>,0,1,'<?php echo $this->_var['value_0_57890400_1476967725']['tag_name']; ?>')"><a><?php echo $this->_var['value_0_57890400_1476967725']['tag_name']; ?>(<?php echo $this->_var['value_0_57890400_1476967725']['tag_num']; ?>)</a></span>
