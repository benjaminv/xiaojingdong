...
?>
    <tr>
      ...
      <td align="center"><?php if ($this->_var['type']['send_type'] == 5): ?><span>--<?php else: ?><span onclick="listTable.edit(this, 'edit_min_amount', <?php echo $this->_var['type']['type_id']; ?>)"><?php echo $this->_var['type']['min_amount']; ?><?php endif; ?></span></td>
      ...
      <td align="center">
        ...
        <?php endif; ?>
        <?php if ($this->_var['type']['send_type'] != 2 && $this->_var['type']['send_type'] != 4 && $this->_var['type']['send_type'] != 5): ?>
