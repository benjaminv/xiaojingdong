...
<div class="form-div">
  <form action="javascript:searchSnatch()" name="searchForm">
   ...
   <?php echo $this->_var['lang']['lab_order_sn']; ?>
...
选择入驻商
    <select name="select_supplier" id="select_supplier">
      <option value="">请选择</option>   
        ...
        <?php $_from = $this->_var['supplier']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item');if (count($_from)):
    foreach ($_from AS $this->_var['item']):
?>
            <option value="<?php echo $this->_var['item']['supplier_id']; ?>"><?php echo $this->_var['item']['supplier_name']; ?></option>
...
<?php endif; ?>
  ...
  <table cellpadding="3" cellspacing="1">
   ...
   <!--   <th>
      ...
      <!--<th><input onclick='listTable.selectAll(this, "checkboxes")' type="checkbox"><a href="javascript:listTable.sort('card_sn'); "><?php echo $this->_var['lang']['lab_card_sn']; ?></a><?php echo $this->_var['sort_card_sn']; ?></th>-->
    ...
    <?php $_from = $this->_var['order_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('i', 'order');if (count($_from)):
    foreach ($_from AS $this->_var['i'] => $this->_var['order']):
?>
    <tr>
   ...
   <td align="center"><span><?php if ($this->_var['order']['supplier_id'] == 0): ?>网站自营<?php else: ?><?php echo $this->_var['order']['supplier_name']; ?><?php endif; ?></span></td>
...
<!--      <td align="center"><span><?php echo $this->_var['card']['card_sn']; ?></span></td>
      <td align="center"><span><?php if ($this->_var['card']['supplier_id'] == 0): ?>网站自营<?php else: ?><?php echo $this->_var['card']['supplier_name']; ?><?php endif; ?></span></td>
      <td align="center"><span><?php echo $this->_var['card']['user_name']; ?></span></td>
      <td align="center"><span><?php echo $this->_var['card']['goods_price']; ?></span></td>
       <td align="center"><span><?php echo $this->_var['card']['add_date']; ?></span></td>
      <td align="center"><span><?php if ($this->_var['card']['buy_date']): ?><?php echo $this->_var['card']['buy_date']; ?><?php else: ?>未使用<?php endif; ?></span></td>
      <td align="center"><span><?php echo $this->_var['card']['end_date']; ?></span></td>
      <td align="center"><img src="images/<?php if ($this->_var['card']['is_saled']): ?>yes<?php else: ?>no<?php endif; ?>.gif" /></span></td>
      <td align="center"><img src="images/<?php if ($this->_var['card']['is_verification']): ?>yes<?php else: ?>no<?php endif; ?>.gif" /></span></td>
      <td align="center">
        <a href="virtual_goods_card.php?act=edit_replenish&amp;card_id=<?php echo $this->_var['card']['card_id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" border="0" height="16" width="16" /></a>
        <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['card']['card_id']; ?>, '<?php echo $this->_var['lang']['drop_confirm']; ?>', 'remove_card')" title="<?php echo $this->_var['lang']['drop']; ?>"><img src="images/icon_drop.gif" border="0" height="16" width="16" /></a>
      </td>-->
