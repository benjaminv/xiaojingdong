...
?>
  <tr>
	...
	<?php endif; ?>
    <td class="first-cell" style="<?php if ($this->_var['goods']['is_promote']): ?>color:red;<?php endif; ?>"><span onclick="listTable.edit(this, 'edit_goods_name', <?php echo $this->_var['goods']['goods_id']; ?>)">
	<?php if ($this->_var['goods']['is_morning_market'] == 1): ?><font color="#FF0000";>[早市]</font><?php endif; ?><?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?></span></td>
...
?>
      ...
      <?php endif; ?>
      <a href="gettaobao2.php?gid=<?php echo $this->_var['goods']['goods_id']; ?>"><img src="images/comment_icon.png" border="0" width="21" height="18" /></a>
    </td>
  </tr>
  <?php endforeach; else: ?>
...
?>
  ...
  <?php endif; ?>
  <input type="hidden" value="<?php echo $this->_var['lang']['button_submit']; ?>" id="btnSubmit" name="btnSubmit" class="button" disabled="true" />
</div>
</form>
