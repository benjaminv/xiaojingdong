...
<table width="100%">
  ...
  <tr>
    ...
    <td valign="middle">
	  ...
	  <input type="radio" name="send_type" value="4" <?php if ($this->_var['bonus_arr']['send_type'] == 4): ?> checked="true" <?php endif; ?> onClick="showunit(4)"  /><?php echo $this->_var['lang']['send_by']['4']; ?> 
       <input type="radio" name="send_type" value="5" <?php if ($this->_var['bonus_arr']['send_type'] == 5): ?> checked="true" <?php endif; ?> onClick="showunit(5)"  /><?php echo $this->_var['lang']['send_by']['5']; ?> 
    </td>
  </tr>
  ...
  <tr>
   ...
   <tr id="3">
    <td class="label"><?php echo $this->_var['lang']['user_bonus_max']; ?></td>
    <td>
        
        <?php if ($this->_var['bonus_arr']['send_type'] != 4): ?>
        <input type='text' name='user_bonus_max' size='20' />    <br/>
        <?php else: ?>
        <input type='text' name='user_bonus_max' size='20' value="<?php echo $this->_var['bonus_arr']['user_bonus_max']; ?>" onkeyup="this.value=this.value.replace(/[^0-9]/ig,'')" onafterpaste="this.value=this.value.replace(/[^0-9]]/ig,'')" />    <br/>
        <?php endif; ?>
        
	  <span class="notice-span" ><?php echo $this->_var['lang']['bonus_type4_max_notic']; ?></span>   
	  </td>
  </tr>
