  ...
  <form action="ad_position.php" method="post" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
    <table width="100%">
      <tr>
        ...
        <td><input type="text" name="position_name" value="<?php echo $this->_var['posit_arr']['position_name']; ?>" size="30" /><span class="require-field">*</span></td>
      </tr>
      <tr>
        <td class="label"><?php echo $this->_var['lang']['ad_width']; ?></td>
        <td><input type="text" name="ad_width" value="<?php echo $this->_var['posit_arr']['ad_width']; ?>" size="30" /> <?php echo $this->_var['lang']['unit_px']; ?><span class="require-field">*</span></td>
      </tr>
      <tr>
        <td class="label"><?php echo $this->_var['lang']['ad_height']; ?></td>
        <td>
          <input type="text" name="ad_height" value="<?php echo $this->_var['posit_arr']['ad_height']; ?>" size="30" /> <?php echo $this->_var['lang']['unit_px']; ?><span class="require-field">*</span>
        </td>
      </tr>
      <tr>
