...
<?php endif; ?>
  ...
  <table cellpadding="3" cellspacing="1">
    <tr>
      ...
      <th width="25%"><a href="javascript:listTable.sort('act_name'); "><?php echo $this->_var['lang']['act_name']; ?></a><?php echo $this->_var['sort_act_name']; ?></th>
      <th width="25%"><a href="javascript:listTable.sort('goods_name'); "><?php echo $this->_var['lang']['goods_name']; ?></a><?php echo $this->_var['sort_goods_name']; ?></th>
...
?>
    <tr>
      ...
      <td align="center"><?php echo $this->_var['auction']['start_time']; ?></td>
      <td align="center"><?php echo $this->_var['auction']['end_time']; ?></td>
