...
<div class="form-div">
  <form action="javascript:searchActivity()" name="searchForm">
    ...
    <?php echo $this->_var['lang']['act_name']; ?> <input type="text" name="keyword" size="30" />
...
?>
    <tr>
      ...
      <td align="center"><?php echo $this->_var['favourable']['start_time']; ?></td>
      <td align="center"><?php echo $this->_var['favourable']['end_time']; ?></td>
