		  	...
		  	<input type="hidden" id="cat_id" name="cat_id" value="<?php echo $this->_var['goods_cat_id']; ?>">
                  ...
                  <tr>
                      ...
                      <td id="area" class="goods_select_area">
                         ...
                         <?php $_from = $this->_var['district']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'district_0_64617500_1476970020');if (count($_from)):
    foreach ($_from AS $this->_var['district_0_64617500_1476970020']):
?>
                            <span><?php echo $this->_var['district_0_64617500_1476970020']['district_name']; ?>&nbsp;&nbsp;<a href=javascript:del_district_id(<?php echo $this->_var['district_0_64617500_1476970020']['district_id']; ?>,'<?php echo $this->_var['district_0_64617500_1476970020']['district_name']; ?>')>x</a></span>
                            <script>
                               strdistrict_name.push("<span><?php echo $this->_var['district_0_64617500_1476970020']['district_name']; ?>&nbsp;&nbsp;<a href=javascript:del_district_id(<?php echo $this->_var['district_0_64617500_1476970020']['district_id']; ?>,'<?php echo $this->_var['district_0_64617500_1476970020']['district_name']; ?>')>x</a></span>");
                            </script>
		  ...
		  <td >
                      <select name="select_city"  size="8" onchange=getCountyList()>
                          <?php $_from = $this->_var['city']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'city_0_64717500_1476970020');if (count($_from)):
    foreach ($_from AS $this->_var['city_0_64717500_1476970020']):
?>
                          <option value="<?php echo $this->_var['city_0_64717500_1476970020']['city']; ?>"><?php echo $this->_var['city_0_64717500_1476970020']['region_name']; ?></option>
                          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                      </select>
          ...
          <tr id="auto_thumb_1">
            ...
            <td id="auto_thumb_3">
              ...
              <?php if ($this->_var['goods']['goods_thumb']): ?>
                <a href="virtual_goods.php?act=show_image&img_url=<?php echo $this->_var['goods']['goods_thumb']; ?>" target="_blank"><img src="images/yes.gif" border="0" /></a>
              <?php else: ?>
                <img src="images/no.gif" />
              <?php endif; ?>
	   ...
	   <tr>
        ...
        <input type="hidden" value="<?php echo $this->_var['goods']['supplier_id']; ?>" name="supplier_id">
        <!-- 璇︾粏鎻忚堪 -->
