...
?>
    <tr>
      <td align="center"><span><input value="<?php echo $this->_var['topic']['topic_id']; ?>" name="checkboxes[]" type="checkbox"><?php echo $this->_var['topic']['topic_id']; ?></span></td>
      
      <td><?php echo $this->_var['topic']['title']; ?></td>
      
      <td align="center"><?php echo $this->_var['topic']['start_time']; ?></td>
      <td align="center"><?php echo $this->_var['topic']['end_time']; ?></td>
