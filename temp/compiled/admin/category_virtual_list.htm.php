...
?>
  <tr align="center" class="<?php echo $this->_var['cat']['level']; ?>" id="<?php echo $this->_var['cat']['level']; ?>_<?php echo $this->_var['cat']['cat_id']; ?>">
    <td align="left" class="first-cell" >
      ...
      <a href="virtual_goods.php?act=list&extension_code=virtual_good&cat_id=<?php echo $this->_var['cat']['cat_id']; ?>&supp=-1"><?php echo $this->_var['cat']['cat_name']; ?></a>
      <?php elseif ($this->_var['cat']['is_result'] == 1): ?>
      <a href="virtual_goods.php?act=list&extension_code=virtual_good&cat_id=<?php echo $this->_var['cat']['cat_id']; ?>&supp=-1" style="font-size: 14px;"><?php echo $this->_var['cat']['cat_name']; ?></a>
      <?php else: ?>
      <a href="virtual_goods.php?act=list&extension_code=virtual_good&cat_id=<?php echo $this->_var['cat']['cat_id']; ?>&supp=-1" style="color: #CDCDCD;"><?php echo $this->_var['cat']['cat_name']; ?></a>
      <?php endif; ?>
      </span>
    ...
    <!--<td><span onclick="listTable.edit(this, 'edit_grade', <?php echo $this->_var['cat']['cat_id']; ?>)"><?php echo $this->_var['cat']['grade']; ?></span></td>-->
     <td width="10%"><span onclick="listTable.edit(this, 'edit_sort_order', <?php echo $this->_var['cat']['cat_id']; ?>)"><?php echo $this->_var['cat']['sort_order']; ?></span></td>
    <td width="24%" align="center">
      <a href="category.php?act=move_virtual&cat_id=<?php echo $this->_var['cat']['cat_id']; ?>"><?php echo $this->_var['lang']['move_goods']; ?></a> |
