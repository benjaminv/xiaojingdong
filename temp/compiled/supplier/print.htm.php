...
function _create_shipping_print()
{
  ...
  //创建文本
  var config_lable = '<?php echo $this->_var['shipping']['config_lable']; ?>';
...
function _create_print_bg()
{
  ...
  //测试打印效果
  //print_bg.style.background = '<?php echo $this->_var['shipping']['print_bg']; ?>';

  //设置快递单样式
  print_bg.style.width = '<?php echo $this->_var['shipping']['print_bg_size']['width']; ?>px';
  print_bg.style.height = '<?php echo $this->_var['shipping']['print_bg_size']['height']; ?>px';
