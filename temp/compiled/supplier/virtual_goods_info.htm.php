		  ...
		  <?php echo $this->_var['lang']['require_field']; ?>
                  ...
                  <tr>
                      ...
                      <td id="area" class="goods_select_area">
                         ...
                         <?php $_from = $this->_var['district']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'district_0_49374700_1467188581');if (count($_from)):
    foreach ($_from AS $this->_var['district_0_49374700_1467188581']):
?>
                            <span><?php echo $this->_var['district_0_49374700_1467188581']['district_name']; ?>&nbsp;&nbsp;<a href=javascript:del_district_id(<?php echo $this->_var['district_0_49374700_1467188581']['district_id']; ?>,'<?php echo $this->_var['district_0_49374700_1467188581']['district_name']; ?>')>x</a></span>
                            <script>
                               strdistrict_name.push("<span><?php echo $this->_var['district_0_49374700_1467188581']['district_name']; ?>&nbsp;&nbsp;<a href=javascript:del_district_id(<?php echo $this->_var['district_0_49374700_1467188581']['district_id']; ?>,'<?php echo $this->_var['district_0_49374700_1467188581']['district_name']; ?>')>x</a></span>");
                            </script>
		  ...
		  <td >
                      <select name="select_city"  size="8" onchange=getCountyList()>
                          <?php $_from = $this->_var['city']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'city_0_49391100_1467188581');if (count($_from)):
    foreach ($_from AS $this->_var['city_0_49391100_1467188581']):
?>
                          <option value="<?php echo $this->_var['city_0_49391100_1467188581']['city']; ?>"><?php echo $this->_var['city_0_49391100_1467188581']['region_name']; ?></option>
                          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                      </select>
                        <?php echo $this->_var['lang']['require_field']; ?>
