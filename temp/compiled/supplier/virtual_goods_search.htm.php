...
<div class="form-div">
  <form action="javascript:searchGoods()" name="searchForm">
    ...
    <?php $_from = $this->_var['city']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'city_0_81256200_1467188582');if (count($_from)):
    foreach ($_from AS $this->_var['city_0_81256200_1467188582']):
?>
	<?php if ($this->_var['selectKey']['city'] == $this->_var['city_0_81256200_1467188582']['city']): ?>
	 <option value="<?php echo $this->_var['city_0_81256200_1467188582']['city']; ?>" selected="selected"><?php echo $this->_var['city_0_81256200_1467188582']['region_name']; ?></option>
	<?php else: ?>
	<option value="<?php echo $this->_var['city_0_81256200_1467188582']['city']; ?>"><?php echo $this->_var['city_0_81256200_1467188582']['region_name']; ?></option>
	<?php endif; ?>
