...
<tr>
    <td class="label"><?php echo $this->_var['lang']['system_main']; ?>：</td> <td>
...
<tr>
    <td class="label"><?php echo $this->_var['lang']['item_name']; ?>：</td> <td><input type="text" name="item_name" value="<?php echo $this->_var['rt']['item_name']; ?>" id="item_name" size="40" onKeyPress="javascript:key();" /><span class="require-field">*</span></td>
</tr>
<tr>
    <td class="label"><a href="javascript:showNotice('notice_url');" title="<?php echo $this->_var['lang']['notice_url']; ?>"><img src="images/notice.gif" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"><?php echo $this->_var['lang']['item_url']; ?>：</a></td> <td><input type="text" name="item_url" value="<?php echo $this->_var['rt']['item_url']; ?>" id="item_url" size="40" onKeyPress="javascript:key();" /><span class="require-field">*</span>
...
<tr>
    <td class="label"><?php echo $this->_var['lang']['item_vieworder']; ?>：</td> <td><input type="text" name="item_vieworder" value="<?php echo $this->_var['rt']['item_vieworder']; ?>" size="40" /></td>
</tr>
<tr>
    <td class="label"><?php echo $this->_var['lang']['item_ifshow']; ?>：</td> <td><select name="item_ifshow">
...
<tr>
    <td class="label"><?php echo $this->_var['lang']['item_opennew']; ?>：</td> <td><select name="item_opennew">
 ...
 <tr style="display:none">
    <td class="label"><?php echo $this->_var['lang']['item_type']; ?>：</td> <td><select name="item_type">
  <option value='top' <?php echo $this->_var['rt']['item_type_top']; ?>><?php echo $this->_var['lang']['top']; ?></option><option value='middle' <?php echo $this->_var['rt']['item_type_middle']; ?> selected><?php echo $this->_var['lang']['middle']; ?></option><option value='bottom' <?php echo $this->_var['rt']['item_type_bottom']; ?>><?php echo $this->_var['lang']['bottom']; ?></option>
  </select></td>
</tr> 
<tr align="center">
  <td colspan="2">
