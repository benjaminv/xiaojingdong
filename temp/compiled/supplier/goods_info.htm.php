            ...
            <table width="400" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td valign="top" style="padding-left:10px">
                    <!-- <?php $_from = $this->_var['brand_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_20175400_1462877462');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_20175400_1462877462']):
?> -->
                    <!-- <?php if ($this->_var['brand_list_0_20175400_1462877462']['name_p'] >= "a" && $this->_var['brand_list_0_20175400_1462877462']['name_p'] <= "g"): ?> -->
                    <div id="@<?php echo $this->_var['key']; ?>"><div id="<?php echo $this->_var['brand_list_0_20175400_1462877462']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_20175400_1462877462']['name']; ?>"><a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_20175400_1462877462']['name']; ?>')"><?php echo $this->_var['brand_list_0_20175400_1462877462']['name']; ?></a></div></div>
                    <!-- <?php endif; ?> -->
                    <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
                  </td>
                  <td valign="top" style="padding-left:10px"> 
                    <!-- <?php $_from = $this->_var['brand_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_20195600_1462877462');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_20195600_1462877462']):
?> -->
                    <!-- <?php if ($this->_var['brand_list_0_20195600_1462877462']['name_p'] >= "h" && $this->_var['brand_list_0_20195600_1462877462']['name_p'] <= "k"): ?> -->
                    <div id="@<?php echo $this->_var['key']; ?>"><div id="<?php echo $this->_var['brand_list_0_20195600_1462877462']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_20195600_1462877462']['name']; ?>"><a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_20195600_1462877462']['name']; ?>')"><?php echo $this->_var['brand_list_0_20195600_1462877462']['name']; ?></a></div></div>
                    <!-- <?php endif; ?> -->
                    <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
                  </td>
                  <td valign="top" style="padding-left:10px">
                    <!-- <?php $_from = $this->_var['brand_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_20214200_1462877462');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_20214200_1462877462']):
?> -->
                    <!-- <?php if ($this->_var['brand_list_0_20214200_1462877462']['name_p'] >= "l" && $this->_var['brand_list_0_20214200_1462877462']['name_p'] <= "s"): ?> -->
                    <div id="@<?php echo $this->_var['key']; ?>"><div id="<?php echo $this->_var['brand_list_0_20214200_1462877462']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_20214200_1462877462']['name']; ?>"><a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_20214200_1462877462']['name']; ?>')"><?php echo $this->_var['brand_list_0_20214200_1462877462']['name']; ?></a></div></div>
                    <!-- <?php endif; ?> -->
                    <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
                  </td>
                  <td valign="top" style="padding-left:10px">
                    <!-- <?php $_from = $this->_var['brand_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_20232800_1462877462');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_20232800_1462877462']):
?> -->
                    <!-- <?php if ($this->_var['brand_list_0_20232800_1462877462']['name_p'] >= "t" && $this->_var['brand_list_0_20232800_1462877462']['name_p'] <= "z"): ?> -->
                    <div id="@<?php echo $this->_var['key']; ?>"><div id="<?php echo $this->_var['brand_list_0_20232800_1462877462']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_20232800_1462877462']['name']; ?>"><a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_20232800_1462877462']['name']; ?>')"><?php echo $this->_var['brand_list_0_20232800_1462877462']['name']; ?></a></div></div>
                    <!-- <?php endif; ?> -->
                    <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
                  </td>
                  <td valign="top" style="padding-left:10px">
                    <!-- <?php $_from = $this->_var['brand_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'brand_list_0_20250800_1462877462');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['brand_list_0_20250800_1462877462']):
?> -->
                    <!-- <?php if ($this->_var['brand_list_0_20250800_1462877462']['name_p'] >= "0" && $this->_var['brand_list_0_20250800_1462877462']['name_p'] <= "9"): ?> -->
                    <div id="@<?php echo $this->_var['key']; ?>"><div id="<?php echo $this->_var['brand_list_0_20250800_1462877462']['name_pinyin']; ?><?php echo $this->_var['brand_list_0_20250800_1462877462']['name']; ?>"><a href="javascript:go_brand_id(<?php echo $this->_var['key']; ?>,'<?php echo $this->_var['brand_list_0_20250800_1462877462']['name']; ?>')"><?php echo $this->_var['brand_list_0_20250800_1462877462']['name']; ?></a></div></div>
                    <!-- <?php endif; ?> -->
                    <!-- <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> -->
                  </td>
                </tr>
...
?>
          ...
          <tr>
              ...
              <td id="promote_7">
                  <input type="text" id="promote_1" name="cost_price" value="<?php echo empty($this->_var['goods']['cost_price']) ? '0.00' : $this->_var['goods']['cost_price']; ?>" size="20" />
                  <br />
