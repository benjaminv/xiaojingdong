...
?>
	 ...
	 <div style="width:850px;margin:auto;">   
		...
		经度：<input name="jingdu" type="text" value="<?php echo $this->_var['supplier_info']['longitude']; ?>" id="jingdu"  style="min-width:90px;"/>
		纬度：<input name="weidu" type="text" value="<?php echo $this->_var['supplier_info']['latitude']; ?>" id="weidu" style="min-width:90px;" /> 
