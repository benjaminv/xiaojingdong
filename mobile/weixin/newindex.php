<?php
// 今天优品多商户系统   QQ  120029121 paleng  技术团队 热风科技
...
//			break;
//		case "kf":
//			$access_token = prince_access_token($db);	// 今天优品多商户系统 Added by PRINCE QQ 120029121
...
function kefutips($access_token, $openid){
    $url = 'https://api.weixin.qq.com/cgi-bin/message/custom/send?access_token='.$access_token;
     $data = '{
						...
						"text":
						{
							 "content":"您好，正在为您转接客服，如客服忙碌，请添加微信：hangu18934716305 "
						}
			}';
    $result = https_request($url, $data);
}
